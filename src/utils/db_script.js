const db_sql = {
    ...
    Q33: `UPDATE rental_items SET status = '{var1}', approval_otp = '{var2}' WHERE id = '{var3}' AND renter_id = '{var4}' AND deleted_at IS NULL RETURNING * `,
...
`,
    ...
    Q48: `SELECT * FROM messages WHERE sender_id = '{var1}' AND receiver_id = '{var2}' OR sender_id = '{var2}' AND receiver_id = '{var1}' AND deleted_at IS NULL ORDER BY created_at ASC `,
    ...
    Q58: `SELECT
                ...
                COALESCE(AVG(reviews.rating), 0) AS average_rating,
                COUNT(DISTINCT reviews.id) AS total_reviews,
                address.id, address.address,address.city,address.state,address.pincode
            FROM
                feature_items
            LEFT JOIN
