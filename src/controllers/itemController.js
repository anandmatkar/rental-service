    ...
    try {
        ...
        if (findUser.rowCount > 0) {
            ...
            if (findItem.rowCount > 0) {
                ...
                let s3 = dbScript(db_sql['Q30'], { var1: item_id, var2: mysql_real_escape_string(item_name), var3: mysql_real_escape_string(description), var4: mysql_real_escape_string(category_name), var5: deposit_price, var6: rental_price, var7: total_price, var8: renter_id, var9: receiver_id, var10: mysql_real_escape_string(renter_name), var11: renter_email, var12: mysql_real_escape_string(receiver_name), var13: receiver_email, var14: start_date, var15: end_date, var16: status, var17: approval_otp, var18: pick_up_time, var19: drop_off_time, var20: mysql_real_escape_string(unit), var21: image })
